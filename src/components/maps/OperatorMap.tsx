      ...
      >
            ...
            >
              <Popup>
                <div className="min-w-[180px]">
                  ...
                  <div className="text-sm text-gray-600">{job.address.street}</div>
        ...
        >
          <Popup>
            ...
            <div className="text-sm text-gray-600">Plow Truck #1</div>
          </Popup>
        </Marker>
      </MapContainer>
    </div>
